...
public class CourseController {
  ...
  @Operation(summary = "Creating a course and store it in database", description = "This accept course object as a request body", parameters = {
          @Parameter(name = "Courses", description = "Accept a Course user Object", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = Courses.class)))}) @ApiResponses(value = {
                  ...
                  @ApiResponse(responseCode = "302", description = "This throw's when course is already present.", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = com.example.demo.exception.ApiResponse.class)))}) @PreAuthorize("hasAuthority('ADMIN')") @PostMapping
  public ResponseEntity<?> createCourse(@RequestBody
  Courses courses) {
  ...
  @Operation(summary = "Deleting a course from database", description = "This accept course id as a Path variable and deletes that particular course form database and its corresponding student and teacher having this course is updated.", parameters = {
          @Parameter(name = "id", description = "The course ID of the course", required = true)}) @ApiResponses(value = {
                  ...
                  @ApiResponse(responseCode = "404", description = "This throw's when course is not present.", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = com.example.demo.exception.ApiResponse.class)))}) @PreAuthorize("hasAuthority('ADMIN')") @DeleteMapping("/delete/{id}")
  public ResponseEntity<?> deleteCourse(@PathVariable(name = "id")
  String id) {
  ...
  @Operation(summary = "Getting a course from database", description = "This accept course id as a Path variable and returns the course.", parameters = {
          @Parameter(name = "id", description = "The course ID of the course", required = true)}) @ApiResponses(value = {
                  ...
                  @ApiResponse(responseCode = "404", description = "This throw's when course is not present.", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = com.example.demo.exception.ApiResponse.class)))}) @PreAuthorize("hasAuthority('ADMIN') or hasAuthority('STUDENT') or hasAuthority('TEACHER')") @GetMapping("/{id}")
  ...
  @Operation(summary = "Updating a course from database", description = "This accept course id as a Path variable and updates that particular course form database and its corresponding student and teacher having this course is updated.", parameters = {
          @Parameter(name = "id", description = "The course ID of the course", required = true)}) @ApiResponses(value = {
                  ...
                  @ApiResponse(responseCode = "404", description = "This throw's when course is not present.", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = com.example.demo.exception.ApiResponse.class)))}) @PreAuthorize("hasAuthority('ADMIN')") @PutMapping("/{id}")
  public ResponseEntity<?> updateCourse(@PathVariable
