...
public class StudentController {
  ...
  @Operation(
      ...
      description =
          "Creating a student object and passing as a request payload then storing it in the database",
      parameters = {
        @Parameter(
            name = "Student",
            description = "Accept a Student user Object",
            content =
                @Content(
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Successfully retrieved the Student Dto",
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
        ...
        @ApiResponse(
            responseCode = "302",
            description = "Student is already present",
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema =
  ...
  @Operation(
      summary = "Adding course to a student",
      description =
          "This accept username and course id as a path variable after that the course get added to the students course list field",
      parameters = {
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "404",
            description =
                "This throw's when either the student username or the course id is not found.",
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema =
  ...
  @Operation(
      summary = "Fetching a Student Details",
      description =
          "This accept username as a path variable after that the corresponding student is fetched",
      parameters = {
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "404",
            description = "This throw's when either the student username  is not found.",
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema =
  ...
  @PreAuthorize(
      "#username == authentication.principal.username  or hasAuthority('ADMIN') or hasAuthority('TEACHER')")
  @GetMapping("/{username}")
