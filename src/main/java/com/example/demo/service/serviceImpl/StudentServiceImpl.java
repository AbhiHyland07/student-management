...
public class StudentServiceImpl implements StudentService {
  ...
  public StudentDTO addStudent(Student student) {
    ...
    if (userNameOptional.isPresent()) {
      throw new ResourceAlreadyPresent(
              "The username " + student.getUsername() + " is already present");
    }
  ...
  public StudentDTO getStudent(String username) {
    Student studentDetails = studentRepository.findByUsername(username).orElseThrow(
            () -> new ResourceNotFound("No student with username " + username + " is present"));
